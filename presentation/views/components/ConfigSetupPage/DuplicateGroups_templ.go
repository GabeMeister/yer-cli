	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(duplicateEngineerGroups) == 0 {
			...
			for _, group := range duplicateEngineerGroups {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `presentation/views/components/ConfigSetupPage/DuplicateGroups.templ`, Line: 15, Col: 23}
				}
				...
				for _, dup := range group.Duplicates {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `presentation/views/components/ConfigSetupPage/DuplicateGroups.templ`, Line: 22, Col: 15}
					}
